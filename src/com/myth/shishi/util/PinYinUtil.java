 ...
 * @version : 1.00 Create Time : 2011-3-22-下午07:04:30 Description :
 *          处理汉字和对应拼音转换的工具类 History： Editor version Time Operation
 *          Description*
 */
public class PinYinUtil
{
    ...
    /**
     * @param src
     * @return author : Robert about version ：1.00 create time :
     *         2011-3-22-下午07:04:27 Description ： 传入汉字字符串，拼接成对应的拼音,返回拼音的集合
     */
    ...
    {
        String lst = PinYinUtil.getPinYin("迭代每个汉字的拼音数组,该分享来自程序员之家");
     ...
     * @param src
     * @return author : Robert about version ：1.00 create time :
     *         2011-3-22-下午02:21:42 Description ： 传入中文汉字，转换出对应拼音
        ...
        try
        {
            for (int i = 0; i < t0; i++)
            {
                ...
                if (Character.toString(t1[i]).matches("[\\u4E00-\\u9FA5]+"))
                {
                    ...
                    if (i == 0)
                    {
                        t4 += captureName(t2[0]) + " ";// 取出该汉字全拼的第一种读音并连接到字符串t4后
                    }
                    else if (i == 1)
                    {
                        t4 += captureName(t2[0]);
     ...
     * @param src
     * @return author : Robert about version ：1.00 create time :
     *         2011-3-22-下午02:52:35 Description ：
     ...
     * @param src
     * @return author : Robert about version ：1.00 create time :
     *         2011-3-22-下午03:03:02 Description ： 传入没有多音字的中文汉字，转换出对应拼音
