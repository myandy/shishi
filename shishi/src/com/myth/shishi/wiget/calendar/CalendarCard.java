...
public class CalendarCard extends RelativeLayout
{
    ...
    private int itemLayout = R.layout.calendar_card_item_simple;
    ...
    private void init(Context ctx)
    {
        if (isInEditMode())
            return;
        View layout = LayoutInflater.from(ctx).inflate(R.layout.calendar_card_view, null, false);
...
//      ((TextView) layout.findViewById(R.id.cardDay1)).setText(cal.getDisplayName(Calendar.DAY_OF_WEEK,
//              Calendar.SHORT, Locale.getDefault()));
//      cal.add(Calendar.DAY_OF_WEEK, 1);
//      ((TextView) layout.findViewById(R.id.cardDay2)).setText(cal.getDisplayName(Calendar.DAY_OF_WEEK,
//              Calendar.SHORT, Locale.getDefault()));
//      cal.add(Calendar.DAY_OF_WEEK, 1);
//      ((TextView) layout.findViewById(R.id.cardDay3)).setText(cal.getDisplayName(Calendar.DAY_OF_WEEK,
//              Calendar.SHORT, Locale.getDefault()));
//      cal.add(Calendar.DAY_OF_WEEK, 1);
//      ((TextView) layout.findViewById(R.id.cardDay4)).setText(cal.getDisplayName(Calendar.DAY_OF_WEEK,
//              Calendar.SHORT, Locale.getDefault()));
//      cal.add(Calendar.DAY_OF_WEEK, 1);
//      ((TextView) layout.findViewById(R.id.cardDay5)).setText(cal.getDisplayName(Calendar.DAY_OF_WEEK,
//              Calendar.SHORT, Locale.getDefault()));
//      cal.add(Calendar.DAY_OF_WEEK, 1);
//      ((TextView) layout.findViewById(R.id.cardDay6)).setText(cal.getDisplayName(Calendar.DAY_OF_WEEK,
//              Calendar.SHORT, Locale.getDefault()));
//      cal.add(Calendar.DAY_OF_WEEK, 1);
//      ((TextView) layout.findViewById(R.id.cardDay7)).setText(cal.getDisplayName(Calendar.DAY_OF_WEEK,
//              Calendar.SHORT, Locale.getDefault()));
      ...
      ((TextView) layout.findViewById(R.id.cardDay7)).setText("六");
        ...
        mOnItemRenderDefault = new OnItemRender()
        {
            ...
            {
                ((TextView) v.findViewById(R.id.tv)).setText(item.getDayOfMonth().toString());
            }
        };
    ...
    private void updateCells()
    {
        ...
        if (daySpacing > 0)
        {
            ...
            for (int i = 0; i < daySpacing; i++)
            {
                ...
                (mOnItemRender == null ? mOnItemRenderDefault : mOnItemRender).onRender(cell,
                        (CardGridItem) cell.getTag());
                counter++;
